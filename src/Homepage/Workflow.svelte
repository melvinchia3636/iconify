...
<div class="w-full px-16">
  <p class=" font-medium text-2xl text-center tracking-wide">Workflow</p>
  <h2 class="text-6xl font-semibold tracking-wide  text-center mb-16">
  ...
  <div class="flex flex-col gap-16 relative">
    ...
    <div class="flex gap-12">
      <div class="w-full">
        <div class="bg-stone-600  py-4 px-5  ">
          <code>
            &lt;<span style="all: inherit; color: rgb(49, 141, 225)">span</span>
            class="<span style="all: inherit; color: rgb(225, 62, 49);"
              >iconify</span
            >" data-icon="<span style="all: inherit; color: rgb(225, 62, 49);"
              >fa:home</span
            >"&gt;&lt;/<span style="all: inherit; color: rgb(49, 141, 225)"
              >span</span
            >&gt;
            <br />
            &lt;<span style="all: inherit; color: rgb(49, 141, 225)">span</span>
            ...
            >" data-icon="<span style="all: inherit; color: rgb(225, 62, 49);"
              >mdi:alert"</span
            >&gt;&lt/<span style="all: inherit; color: rgb(49, 141, 225)"
              >span</span
            >&gt;
          </code>
        </div>
      ...
      <div
        class="bg-stone-600  font-medium text-3xl rounded-full w-16 h-16 flex-shrink-0 flex items-center justify-center"
      >
        01
      </div>
    ...
    <div class="flex gap-12">
      <div class="w-full inline-flex gap-2 justify-end mt-2">
        <div
          class="px-4 py-2 h-12 bg-stone-1000    font-medium text-lg tracking-wide"
        >
          fa:home
        </div>
        <div
      ...
      <div class="w-full mt-4">
        <Paragraph>Script retrieves icon names from placeholders.</Paragraph>
      </div>
    </div>
    <div class="flex gap-12">
      <div class="w-full flex gap-4 justify-between -mt-20">
        <div class="flex-shrink-0 flex flex-col justify-center items-center ">
          <p class=" font-medium text-2xl tracking-wide mb-4">Client</p>
          <svg
            width="58"
            height="58"
            viewBox="0 0 58 58"
        ...
        >
          <div class="flex flex-col justify-center items-center gap-2">
            ...
            <div class="arrow">
              <svg
                ...
                viewBox="0 0 350 2"
                data-icon="website:process-line"
                data-height="auto"
          ...
          <div class="flex flex-col justify-center items-center gap-2">
            ...
            <p class="text-stone-500 text-lg tracking-wide">
              SVG data (in bulk)
            </p>
          </div>
        </div>
        <div class="flex-shrink-0 flex flex-col items-center justify-center">
          <p class=" font-medium text-2xl tracking-wide mb-4">Server</p>
          <svg
            width="58"
            height="58"
            viewBox="0 0 58 58"
          ...
          >
            <path
              d="M4.83215 9.66787C4.83215 4.32825 15.6528 0 29 0C42.3473 0 53.1679 4.32825 53.1679 9.66787V14.5C53.1679 19.8396 42.3473 24.1679 29 24.1679C15.6528 24.1679 4.83215 19.8396 4.83215 14.5V9.66787Z"
              fill="#318DE1"
            />
            <path
              d="M4.83215 22.9609V33.8359C4.83215 39.1683 15.6528 43.5002 29 43.5002C42.3473 43.5002 53.1679 39.1719 53.1679 33.8323V22.9609C51.5354 24.1369 49.7593 25.0993 47.8826 25.8247C42.8113 27.8547 36.1304 29.0002 29 29.0002C21.8733 29.0002 15.1924 27.8511 10.121 25.8247C8.24437 25.0994 6.46821 24.137 4.83578 22.9609H4.83215Z"
              fill="#318DE1"
            />
            <path
              d="M53.1679 42.2966C51.5352 43.4713 49.7591 44.4325 47.8826 45.1567C42.8076 47.1867 36.1304 48.3322 28.9964 48.3322C21.8697 48.3322 15.1888 47.1867 10.1174 45.1567C8.24078 44.4313 6.46462 43.4689 4.83215 42.293V48.3322C4.83215 53.6718 15.6528 58.0001 29 58.0001C42.3473 58.0001 53.1679 53.6718 53.1679 48.3322V42.2966Z"
              fill="#318DE1"
            />
          </svg>
        </div>
      ...
      <div class="w-full mt-4">
        <Paragraph>
          Script connects to Iconify API and retrieves SVG data for all icons
          found on page.
          <br /><br />
          Iconify API is hosted on network of servers spread across the world, so
          data would load in fraction of a second from any location.
        </Paragraph>
      </div>
    </div>
    <div class="flex gap-12">
      <div class="w-full">
        <div class="bg-stone-600  py-4 px-5  ">
          <code>
            &lt;p&gt;This is a sample icon <span
              style="all: inherit; color: rgb(225, 62, 49);"
              >&lt;svg class="iconify" data-icon="fa:home"
              ...&gt;...&lt;/svg&gt;</span
            >&lt;/p&gt;
            <br /><br />
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<span
              style="all: inherit; color: rgb(225, 62, 49);"
              >&lt;svg data-icon="mdi:alert" ...&gt;...&lt;/svg&gt;</span
            >
            <br />
            &lt;/div&gt;
          </code>
