...
<div class="w-full px-16">
    ...
    <h2 class="text-6xl font-semibold tracking-wide text-stone-600 text-center mb-16">How does Iconify work?</h2>
    <div class="flex flex-col gap-16 relative">
        <div class="big-arrow"></div>
        <div class="flex gap-12">
            <div class="w-full">
                <div class="bg-stone-600 text-stone-600 py-4 px-5  ">
                    <code>
        ...
        <div class="flex gap-12">
            <div class="w-full flex gap-4 justify-between -mt-20">
                <div class="flex-shrink-0 flex flex-col justify-center items-center ">
                    <p class="text-stone-600 font-medium text-2xl tracking-wide mb-4">Client</p>
                ...
                <div class="w-full flex flex-col justify-center items-center gap-8 mt-12">
                    ...
                    <div class="flex flex-col justify-center items-center gap-2">
                        ...
                        <p class="text-stone-500 text-lg tracking-wide">SVG data (in bulk)</p>
                    </div>
                </div>
                <div class="flex-shrink-0 flex flex-col items-center justify-center">
                    <p class="text-stone-600 font-medium text-2xl tracking-wide mb-4">Server</p>
                    <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
