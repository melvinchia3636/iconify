...
<div class="w-full px-0 md:px-16">
    <p class="text-stone-600 font-medium text-xl mb-2 text-center tracking-wide">Feautres</p>
    <h2 class="text-5xl font-semibold tracking-wide text-stone-600 text-center mb-6 lg:mb-12">Many icons, one framework</h2>
    <Paragraph>
        <div class="">
    ...
    <div class="pt-20 w-full flex flex-col gap-24">
        <div class="flex flex-col sm:flex-row gap-12 items-center">
            <div class="w-full sm:w-1/2">
                <h3 class="text-stone-600 font-semibold tracking-wide text-3xl mb-6 sm:mb-8">Load on demand</h3>
                <Paragraph>
                    <div class="text-base">
            ...
            <div class="w-full sm:w-1/2">
                <div class="flex gap-6 flex-col relative">
                    <div class="arrow"></div>                
                    <div class="border-2 border-stone-600 w-full flex flex-col">
                        <h4 class="text-stone-600 text-2xl md:text-3xl tracking-wide text-center font-medium m-6">API</h4>
                        <img src="./assets/iconsdemo.svg" alt="icons example w-full" />
                        <p class="text-stone-600 text-lg tracking-wide text-center m-6">100,000+ icons</p>
                    </div>
                    <div class="border-2 border-stone-600 w-full">
                        <div class="flex flex-wrap justify-center gap-2 m-6">
                            <div class="px-3 py-2 border-2 border-stone-600 text-stone-600 font-medium text-lg tracking-wide">mdi:opacity</div>
                            <div class="px-3 py-2 border-2 border-stone-600 text-stone-600 font-medium text-lg tracking-wide">ion:ios-cart</div>
                            <div class="px-3 py-2 border-2 border-stone-600 text-stone-600 font-medium text-lg tracking-wide">mdi:flask</div>
                            <div class="px-3 py-2 border-2 border-stone-600 text-stone-600 font-medium text-lg tracking-wide">noto:anchor</div>
                            <div class="px-3 py-2 border-2 border-stone-600 text-stone-600 font-medium text-lg tracking-wide">fxemoji:alien</div>
                        </div>
                        <p class="text-stone-600 text-lg tracking-wide text-center m-6">Only icons used on page are downloaded</p>
                    </div>
                    <div class="border-2 border-stone-600 w-full">
                        <h4 class="text-stone-600 text-2xl md:text-3xl tracking-wide text-center font-medium m-6">Browser</h4>
                        <div class="w-full flex justify-center">
                            <img src="./assets/iconsdemoresult.svg" alt="icons example" class="w-96" />
                        </div>
                        <p class="text-stone-600 text-lg tracking-wide text-center m-6">5 icons = ~2.5 Kb of data (~0.5 Kb per icon) </p>
                    </div>
                </div>
            </div>
        </div>
        <div class="flex flex-col-reverse sm:flex-row gap-12 items-center">
            <div class="w-full sm:w-1/2">
                <div class="border-2 border-stone-600 text-stone-600 py-4 px-5  mt-4 mb-4">
                ...
                <div class="w-full h-64 flex flex-col  border border-stone-600">
                    <div class="flex items-center gap-2 p-3 border-b border-stone-600">
            ...
            <div class="w-full sm:w-1/2">
                <h3 to use class="text-stone-600 font-semibold tracking-wide text-3xl mb-6 sm:mb-8">Easy to use</h3>
                <Paragraph>
                    <div class="text-base">
        ...
        <div class="flex flex-col sm:flex-row gap-12 items-center">
            <div class="w-full sm:w-1/2">
                <h3 to use class="text-stone-600 font-semibold tracking-wide text-3xl mb-6 sm:mb-8">Over 100,000 icons to choose from</h3>
                <Paragraph>
                ...
                <div class="flex relative h-full flex-col items-center">
                    ...
                    {#each icon_sets as icon_set, index}
                        {#if index == current_icon_set}
                            ...
                            <h5 class="text-stone-600 font-medium text-xl tracking-wider mt-16 absolute top-28 380:top-36 pt-2 xl:top-64 whitespace-nowrap" in:fade out:fade>{icon_set[2]} icons</h5>
                        {/if}
                    {/each}
                </div>
        ...
        <div class="flex flex-col-reverse sm:flex-row gap-12 items-center">
            ...
            <div class="w-full 530:sm:w-1/2">
                <h3 to use class="text-stone-600 font-semibold tracking-wide text-3xl mb-6 sm:mb-8">Lightning fast</h3>
                <Paragraph>
                    <div class="text-base">
