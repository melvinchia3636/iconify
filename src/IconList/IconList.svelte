      ...
      >
        {#each filteredIconList as icon}
          ...
          >
            ...
            />
            <p
              class="font-medium text-[0.7rem] tracking-wide text-center text-stone-600 mt-4 -mb-0.5"
            >
      ...
      >
        {#each filteredIconList as icon}
          <div
            ...
            class="flex items-center border-2 border-stone-600 cursor-pointer transition-all hover:bg-stone-200 dark:hover:bg-opacity-60 p-4"
          >
            <Icon
              icon={`${iconSet}:${icon.name || icon}`}
              width="24"
            ...
            />
            <p
              class="font-medium text-sm tracking-wide text-stone-600 truncate ml-3 -mb-0.5"
            >
              {icon.name || icon}
            </p>
          </div>
