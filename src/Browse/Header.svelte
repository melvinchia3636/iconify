...
<h1
  class="mb-4 text-2xl font-semibold tracking-wide text-center  sm:mb-8 sm:text-5xl mt-12"
>
  Browse Icons
</h1>
<Paragraph>
  <p class="text-center text-base ">
    All icon sets listed below are released by their authors with some kind of
