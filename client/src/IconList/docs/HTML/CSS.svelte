...
<CodeSnippet>background: url('{urlString}') no-repeat center center / contain;</CodeSnippet>
<CodeSnippet>content: url('{urlString}') no-repeat center center / contain;</CodeSnippet>
