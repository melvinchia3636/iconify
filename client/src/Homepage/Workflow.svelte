...
<div class="w-full px-16">
    <p class="text-stone-600 font-medium text-2xl text-center tracking-wide">Workflow</p>
    <h2 class="text-6xl font-semibold tracking-wide text-zinc-600 dark:text-stone-600 text-center mb-16">How does Iconify work?</h2>
    <div class="flex flex-col gap-16 relative">
        <div class="big-arrow"></div>
        <div class="flex gap-12">
            <div class="w-full">
                <div class="bg-stone-600 text-zinc-600 dark:text-stone-600 py-4 px-5  ">
                    <code>
            ...
            <div class="bg-stone-600 text-stone-600 font-medium text-3xl rounded-full w-16 h-16 flex-shrink-0 flex items-center justify-center">01</div>
        ...
        <div class="flex gap-12">
            <div class="w-full inline-flex gap-2 justify-end mt-2">
                <div class="px-4 py-2 h-12 bg-stone-1000   text-stone-600 font-medium text-lg tracking-wide">fa:home</div>
                <div class="px-4 py-2 h-12 bg-stone-1000   text-stone-600 font-medium text-lg tracking-wide">mdi:alert</div>
            </div>
            <div class="bg-stone-600 text-stone-600 font-medium text-3xl rounded-full w-16 h-16 flex-shrink-0 flex items-center justify-center">02</div>
            <div class="w-full mt-4">
                <Paragraph>
        ...
        <div class="flex gap-12">
            <div class="w-full flex gap-4 justify-between -mt-20">
                <div class="flex-shrink-0 flex flex-col justify-center items-center ">
                    <p class="text-zinc-600 dark:text-stone-600 font-medium text-2xl tracking-wide mb-4">Client</p>
                ...
                <div class="flex-shrink-0 flex flex-col items-center justify-center">
                    <p class="text-zinc-600 dark:text-stone-600 font-medium text-2xl tracking-wide mb-4">Server</p>
                    <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="bg-stone-600 text-stone-600 font-medium text-3xl rounded-full w-16 h-16 flex-shrink-0 flex items-center justify-center">03</div>
            <div class="w-full mt-4">
                <Paragraph>
        ...
        <div class="flex gap-12">
            ...
            <div class="bg-stone-600 text-stone-600 font-medium text-3xl rounded-full w-16 h-16 flex-shrink-0 flex items-center justify-center">04</div>
            <div class="w-full mt-4">
                <Paragraph>
