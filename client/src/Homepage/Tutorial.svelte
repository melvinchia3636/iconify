...
<div class="w-full px-0 md:px-16">
    <p class="text-yellow-400 font-medium text-xl ssssm:text-2xl text-center tracking-wide">Get Started</p>
    <h2 class="text-4xl ssssm:text-5xl sm:text-6xl lg:text-5xl xl:text-6xl font-semibold tracking-wide text-zinc-600 dark:text-zinc-100 text-center mb-6 lg:mb-12">How to use Iconify</h2>
    <Paragraph>
    ...
    <div class="bg-zinc-100 text-zinc-600 dark:text-zinc-100 py-4 px-5  shadow-md mt-4 mb-8">
