...
<div class="w-full flex flex-col lg:flex-row gap-12 lg:gap-20 items-center px-0 md:px-16">
    <div class="text-4xl ssssm:text-5xl sm:text-6xl lg:text-5xl xl:text-6xl font-semibold tracking-wide text-center !leading-tight whitespace-nowrap text-gray-700">
