...
<nav class="flex items-cente justify-between w-full mb-8">
    ...
    <Link to="/icon-sets" class="bg-red-500 px-6 pt-3 pb-4 text-white font-semibold text-xl tracking-wide rounded-md flex items-center gap-6">
        Browse Icons
